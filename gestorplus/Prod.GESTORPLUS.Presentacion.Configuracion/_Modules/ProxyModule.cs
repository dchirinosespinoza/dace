...
namespace Prod.GESTORPLUS.Presentacion.Configuracion._Modules
{
    public class ProxyModule : Autofac.Module
    {
        ...
        {
            //Proxy Local
            builder.RegisterAssemblyTypes(Assembly.Load(new AssemblyName("Prod.GESTORPLUS.Presentacion.Configuracion")))
