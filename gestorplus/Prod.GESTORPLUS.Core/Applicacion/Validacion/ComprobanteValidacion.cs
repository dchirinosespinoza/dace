...
{
    public class ComprobanteValidacion : ValidacionGenerica
    {
        private IContext _context;
        private IUnitOfWork _uow;
        public readonly IConfiguration _configuration;
        public ComprobanteValidacion(IUnitOfWork unitOfWork, IConfiguration configuration)
        {
            _uow = unitOfWork;
        ...
        public List<string> ValidarRegistro(ComprobanteRequest request)
        {
            /*DACE
        ...
        public List<string> ValidarActualizar(ComprobanteRequest request)
        {
            /*DACE
            switch (request.id_tipo_identificacion)
            {
        ...
        public List<string> ValidarRegistrarDetalle(DetalleComprobanteRequest request)
        {
            return Msg;
        }
        public List<string> ValidarEliminarDetalle(DetalleComprobanteRequest request)
        {
            return Msg;
        }
        public List<string> ValidarDescargarAdjuntos(DetalleComprobanteRequest request)
        {
            return Msg;
        }
    }
