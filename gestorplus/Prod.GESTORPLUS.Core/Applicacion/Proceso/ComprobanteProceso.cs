...
namespace Prod.GESTORPLUS.Core.Applicacion
{
    public class ComprobanteProceso : AccionGenerica<PersonaRequest>
    {
        private IContext _context;
        private IUnitOfWork _uow;

        public ComprobanteProceso(IUnitOfWork unitOfWork)
        {
            _uow = unitOfWork;
        ...
        {
            var sr = new StatusResponse { Value = request.id_persona };
