...
namespace Prod.GESTORPLUS.Servicios.Host
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseMvc();
            app.Run(context => context.Response.WriteAsync($"<h1 style='color:blue;'>Prod.GESTORPLUS.Core.API Environment: {env.EnvironmentName}</h1>"));
        }
    }
}
