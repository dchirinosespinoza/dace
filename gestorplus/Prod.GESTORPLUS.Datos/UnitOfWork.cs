...
namespace Prod.GESTORPLUS.Datos
{
    public class UnitOfWork : BaseUnitOfWork, IUnitOfWork
    {
        ...
        #region REGISTER
        public bool p_REGISTER_Registrar(Register register)
        {
            var para = new Parameter[]
            {
                //new Parameter("@ID_COMPROBANTE_PAGO",request.idComprobantePago),
            ...
            var result = this.ExecuteNonQuery("p_REGISTER_Registrar", CommandType.StoredProcedure, ref para) > 0;
            return result;
        }
        #endregion
    }
